...
export default function InsuranceAuditTax() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
      ...
      {/* Financial Services Highlight Image */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            >
              ...
              <p className="text-text-secondary mb-6 leading-relaxed">
                Protect your business with our comprehensive insurance, audit, and tax services. Our expert team ensures regulatory compliance and helps optimize your financial position.
              </p>
